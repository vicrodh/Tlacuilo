<script lang="ts">
  import { LayoutList, MessageSquare, Bookmark, Search, Info, Paperclip, ChevronRight, ChevronLeft } from 'lucide-svelte';
  ...
  type TabId = 'pages' | 'annotations' | 'bookmarks' | 'search' | 'info' | 'attachments';
